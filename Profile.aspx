...
<asp:Content ID="ProfileContent" ContentPlaceHolderID="MainWindow" runat="server">
    <div>
        <h1 class="pageHead" id="profileHead">Profile of 
            <asp:Label ID="lblName1" runat="server" Text="1"></asp:Label></h1>
    </div>
    <div class="flex-field" id="flex-field">
        <div class="flex-profile" id="flex-profile">
            <div>
                <img class="imgSizing" id="profileImg" src="Images/default-user-image.png" />
            </div>
            <div id="profileInfo">
                <div class="errLbl" id="profileNameText">
        ...
        <div id="profileBio">
            <textarea class="textBox" id="bioText" name="Bio"></textarea>
        </div>
    </div>
